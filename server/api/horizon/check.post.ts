...
function loadGrid(): HorizonGrid {
  ...
  const gridPath = join(process.cwd(), 'public', 'eclipse-data', 'horizon-grid.json')
  gridCache = JSON.parse(readFileSync(gridPath, 'utf-8')) as HorizonGrid
  console.log(`[Horizon] Loaded pre-computed grid: ${gridCache.point_count} points`)
  return gridCache
}
