...
UPDATE viewing_spots SET photos = '[{"filename":"sandafell-thingeyri-hero.webp","alt":"Westfjords landscape seen from Sandafell Mountain (Þingeyri, Iceland)","credit":"Shutterstock / MartiBstock","license":"Shutterstock (Standard License)","is_hero":true,"horizon_view":false}]' WHERE slug = 'sandafell-thingeyri';
