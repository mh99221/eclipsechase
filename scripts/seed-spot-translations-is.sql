...
-- ON CONFLICT (spot_slug, locale) DO UPDATE so it acts as an upsert.
--
...
INSERT INTO viewing_spot_translations (spot_slug, locale, name, description, parking_info, terrain_notes, warnings) VALUES
