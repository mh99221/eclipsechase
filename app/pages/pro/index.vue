...
// Free-vs-Pro comparison is now in <ProCompareTable> (shared with the
// landing's teaser section). Edit the row data there, not here.
</script>
...
<template>
  <PageShell screen="pro" width="reading">
    <div class="pro-body">
      ...
      <!-- Free vs Pro comparison. Shared <ProCompareTable> component
           keeps this page and the landing's FREE VS PRO teaser in sync. -->
      <Card class="compare-card">
        <ProCompareTable show-header show-tagline />
      </Card>
